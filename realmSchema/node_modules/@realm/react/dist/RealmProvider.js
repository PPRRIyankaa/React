 ...
 */
export function createRealmProvider(realmConfig, RealmContext) {
    /**
 ...
 */
export function mergeRealmConfiguration(configA, configB) {
 ...
 */
export function areConfigurationsIdentical(a, b) {
    return isEqual(a, b);
}
